"""
Django settings for OWScheduler project.
...
SECRET_KEY = '8-#7i9ven#h%w$dfy^kw_a&vv_ct0b^*e@p6x0$-0t4=75e&s5'
...
WSGI_APPLICATION = 'OWScheduler.wsgi.application'
