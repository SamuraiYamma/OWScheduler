...
from scheduler.views import user_logout, register, change_password, \
    reset_password, TeamAutoComplete, PlayerAutoComplete
...
urlpatterns = [
    ...
    url(r'^/reset/(?P<uidb64>\w*)/(?P<token>[^/]+)/', auth_views.PasswordResetConfirmView.as_view(), name="password_reset_confirm"),
